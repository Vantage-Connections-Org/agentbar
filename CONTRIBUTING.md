...
| `site/` | The website (Next.js), deployed to https://getagentbar.vercel.app. |
...
- AgentBar only **reads** files that Claude Code and Codex already keep. It never writes to them and makes no network requests. Keep it that way.
